...
export default function Product(props) {
    ...
    return (
        ...
        <div className="card h-100 d-flex flex-column">
            ...
            <img className="product-image mx-auto card-img-top" src={props.product.productImage} alt={props.product.productName} />
            <div className="card-body">
                <h5 className="card-title">{props.product.productName}</h5>
                
            </div>
            <ul className="list-group list-group-flush">
                <li className="list-group-item">Price: ${props.product.productPrice}</li>
                <li className="list-group-item">Rating: {props.product.productRating} ☆</li>
