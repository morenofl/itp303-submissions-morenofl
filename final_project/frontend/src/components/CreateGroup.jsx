...
export default function CreateGroupForm({
	...
	useEffect(() => {
		const fetchDepartments = async () => {
			try {
				const res = await fetch('https://studymatch.onrender.com/api/departments');
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			if (isEdit && initialValues.group_id) {
				res = await fetch(`https://studymatch.onrender.com/api/groups/${initialValues.group_id}`, {
					method: 'PUT',
				...
				res = await fetch('https://studymatch.onrender.com/api/groups', {
					method: 'POST',
					headers: { 'Content-Type': 'application/json' },
					credentials: 'include',
					body: JSON.stringify(groupPayload)
